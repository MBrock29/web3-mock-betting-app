...
const withdrawFunction = () => {
  ...
  return (
    <AppContext.Provider value={{ fractions, setFractions, handleChange, depositFunction, withdrawFunction, depositing, withdrawing, settings, setDepositing, setWithdrawing, setSettings }}>
      {children}
    </AppContext.Provider>
  );
};
